...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 04-12-2016 a las 22:20:15
...
INSERT INTO `cliente` (`idPersona`, `apellidos`, `razonSocial`, `idTipoCliente`) VALUES
(2, 'Amaya Diaz', '', 1),
(3, '', 'Santamaria S.A.', 2),
(4, 'Albulú Castillo', '', 1),
(5, '', 'Barnuevo E.I.R.L', 2),
(7, 'Castillo Cárdenas', '', 1),
(8, '', 'Castro S.A.', 2),
(11, 'Guevara Barreto', '', 1),
(12, '', 'Gutierrez S.A.C', 2),
(18, 'Pérez Suclupe', '', 1),
(20, '', 'Ramos S.A.', 2),
(21, 'Requejo Mejia', '', 1),
(24, '', 'Santisteban E.I.R.L', 2),
(27, 'Zarate Zarate', '', 1),
(33, '', 'Muñoz S.A.', 2),
(34, 'Neria Colmenares', '', 1),
(35, '', 'Nuñez S.A.', 2);
...
CREATE TABLE IF NOT EXISTS `comprobantecompra` (
  ...
  `idPersonaProveedor` int(11) NOT NULL
...
INSERT INTO `comprobantecompra` (`idComprobanteCompra`, `fecha`, `idPersonaProveedor`) VALUES
(1, '2015-05-06 10:00:00', 14),
(2, '2015-05-06 10:00:00', 9),
(3, '2015-05-15 10:00:00', 25),
(5, '2015-05-21 10:00:00', 13),
(6, '2015-05-21 10:00:00', 22),
(7, '2015-06-06 10:00:00', 10),
(8, '2015-06-08 10:00:00', 1),
(9, '2015-06-15 10:00:00', 29),
(10, '2015-06-21 10:00:00', 37),
(11, '2016-06-30 10:00:00', 9),
(12, '2016-07-01 10:00:00', 15),
(13, '2015-07-02 10:00:00', 16);
...
(1, 'F-001-000001', '2016-08-05 10:00:00', 'Realizando Ventas', '400.00', b'1', 2),
(2, 'B-001-000001', '2016-09-05 10:00:00', 'Realizando Ventas', '240.00', b'1', 1),
(3, 'F-001-000002', '2016-05-10 10:00:00', 'Realizando Ventas', '240.00', b'1', 2),
(4, 'B-001-000002', '2016-05-11 10:00:00', 'Realizando Ventas', '80.00', b'1', 1),
(5, 'F-001-000003', '2016-05-12 10:00:00', 'Realizando Ventas', '200.00', b'1', 2),
(6, 'B-001-000003', '2016-05-13 10:00:00', 'Realizando Ventas', '880.00', b'1', 1),
(7, 'F-001-000004', '2016-05-14 10:00:00', 'Realizando Ventas', '840.00', b'1', 2),
(8, 'B-001-000004', '2016-05-15 10:00:00', 'Realizando Ventas', '160.00', b'1', 1),
(9, 'F-001-000005', '2016-05-16 10:00:00', 'Realizando Ventas', '440.00', b'1', 2),
(10, 'B-001-000005', '2016-05-17 10:00:00', 'Realizando Ventas', '1300.00', b'1', 1),
(11, 'F-001-000006', '2016-05-18 10:00:00', 'Realizando Ventas', '1240.00', b'0', 2),
(12, 'B-001-000006', '2016-05-19 10:00:00', 'Realizando Ventas', '2500.00', b'1', 1),
(13, 'F-001-000007', '2016-05-20 10:00:00', 'Realizando Ventas', '1400.00', b'1', 2),
(14, 'B-001-000007', '2016-05-21 10:00:00', 'Realizando Ventas', '1280.00', b'1', 1),
(15, 'F-001-000008', '2016-05-22 10:00:00', 'Realizando Ventas', '1400.00', b'1', 2),
(16, 'B-001-000008', '2016-05-23 10:00:00', 'Realizando Ventas', '60.00', b'1', 1),
(17, 'F-001-000009', '2016-05-24 10:00:00', 'Realizando Ventas', '40.00', b'1', 2),
(18, 'B-001-000009', '2016-05-25 10:00:00', 'Realizando Ventas', '160.00', b'1', 1),
(19, 'F-001-000010', '2016-05-26 10:00:00', 'Realizando Ventas', '1180.00', b'1', 2),
(20, 'B-001-000010', '2016-05-27 10:00:00', 'Realizando Ventas', '1140.00', b'0', 1),
(21, 'F-001-000011', '2016-05-08 10:00:00', 'Realizando Ventas', '2000.00', b'1', 2),
(22, 'B-001-000011', '2016-05-29 10:00:00', 'Realizando Ventas', '1240.00', b'1', 1),
(23, 'F-001-000012', '2016-05-30 10:00:00', 'Realizando Ventas', '1240.00', b'0', 2),
(24, 'B-001-000012', '2016-05-31 10:00:00', 'Realizando Ventas', '2320.00', b'1', 1),
(25, 'F-001-000013', '2016-06-01 10:00:00', 'Realizando Ventas', '1320.00', b'0', 2),
(26, 'B-001-000013', '2016-10-28 10:00:00', '', '151.16', b'1', 1);
...
CREATE TABLE IF NOT EXISTS `detallecompra` (
  ...
  `idComprobanteCompra` int(11) NOT NULL,
  `idProductoRepuesto` int(11) NOT NULL
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
...
INSERT INTO `detallecompra` (`idDetalleCompra`, `cantidad`, `montoTotal`, `idComprobanteCompra`, `idProductoRepuesto`) VALUES
(1, 50, '2500.00', 1, 1),
(2, 25, '1125.00', 3, 5),
(3, 20, '3600.00', 5, 17),
(4, 15, '3000.00', 7, 13),
...
INSERT INTO `empleado` (`idPersona`, `apellidos`, `idTipoEmpleado`) VALUES
(6, 'Cantos Morante', 1),
(17, 'Otero Arrascue', 2),
...
INSERT INTO `kardex` (`idKardex`, `detalle`, `cantidadIngreso`, `precioIngreso`, `cantidadSalida`, `precioSalida`, `idProductoRepuesto`) VALUES
(1, 'Manilla', 200, '50.00', 150, '50.00', 1),
(2, 'Manilla interior derecha', 100, '45.00', 50, '45.00', 2),
(3, 'Abrazadera Metalica', 25, '45.00', 12, '45.00', 4),
(4, 'Frenos', 50, '180.00', 15, '180.00', 5),
(5, 'Filtros', 30, '50.00', 10, '50.00', 6),
(6, 'Sistema de Encendidos', 40, '200.00', 15, '200.00', 7),
(7, 'Suspension/Amortiguacion', 15, '100.00', 12, '100.00', 8),
(8, 'Suspension de Ejes', 80, '150.00', 13, '150.00', 9),
(9, 'Guia de Ruedas', 90, '50.00', 14, '50.00', 10),
(10, 'Carroceria', 120, '80.00', 25, '80.00', 11),
(11, 'Sistema Electrico', 236, '180.00', 16, '180.00', 12),
(12, 'Refrigeracion', 12, '90.00', 6, '90.00', 13),
(13, 'Motor', 55, '5000.00', 19, '5000.00', 14),
(14, 'Calefaccion', 45, '202.00', 14, '202.00', 15),
(15, 'Ventilacion', 70, '150.00', 17, '150.00', 16),
(16, 'Alimentacion de Combustible', 78, '150.00', 12, '150.00', 17),
(17, 'Limpieza de Cristales', 98, '100.00', 14, '100.00', 18),
(18, 'Disco de Frenos', 66, '80.00', 45, '80.00', 19),
(19, 'Juego de pastillas de freno', 77, '50.00', 14, '50.00', 20),
(20, 'Disco de Frenos traseros', 88, '20.00', 7, '20.00', 21),
(21, 'Disco de frenos eje delantero', 98, '18.00', 50, '18.00', 22),
(22, 'Juego de pastillas de freno eje delantero', 89, '20.00', 60, '20.00', 23),
(23, 'bombillas para luces intermitentes', 56, '50.00', 25, '50.00', 24),
(24, 'bombillas para luces de marcha atrás', 32, '60.00', 14, '60.00', 25),
(25, 'Capo delantero/Piezas/ Amortiguacion', 45, '80.00', 25, '80.00', 26),
(26, 'Cubiertas/tapas', 15, '90.00', 20, '90.00', 27),
(27, 'Chapa lateral', 25, '18.00', 40, '18.00', 28),
(28, 'Cubierta motor', 30, '20.00', 20, '20.00', 29),
(29, 'FARO/PIEZA INSERTABLE', 50, '180.00', 5, '180.00', 30),
(30, 'LAMPARA PARA FAROS CARRETERA', 258, '20.00', 100, '20.00', 31),
(31, 'LAMPARA PARA LUCES TRASERAS', 45, '50.00', 40, '50.00', 32),
(32, 'LUCES DE LAS PUERTAS', 105, '89.00', 60, '89.00', 33),
(33, 'LUCES TRASERAS', 50, '77.00', 50, '77.00', 34),
(34, 'REVESTIMIENTO', 56, '20.00', 49, '20.00', 35),
(35, 'SPOILER', 20, '178.00', 20, '178.00', 36),
(36, 'INTERMITENTE LATERAL', 50, '190.00', 15, '190.00', 37),
(37, 'LUNAS DE VENTANA', 25, '160.00', 20, '160.00', 38),
(38, 'LAMPARA DE FARO', 74, '123.00', 30, '123.00', 39),
(39, 'GUARDA BARROS/PIEZAS ADOSADAS', 25, '145.00', 14, '145.00', 40),
(40, 'PARACHOQUES/PIEZAS', 156, '50.00', 25, '50.00', 41),
(41, 'MECANISMO/BOMBAS DE DIRECCION', 110, '80.00', 18, '80.00', 42),
(42, 'SUSPENSION DE DIRECCION', 35, '250.00', 19, '250.00', 43),
(43, 'ACEITES', 123, '20.00', 33, '20.00', 44),
(44, 'ESTERILLAS', 145, '50.00', 35, '50.00', 45),
(45, 'CONDENSADOR', 105, '10.00', 36, '10.00', 46),
(46, 'SECADOR', 50, '150.00', 37, '150.00', 47),
(47, 'LUCES DE GALIBO', 90, '189.00', 80, '189.00', 48),
(48, 'CARTER DE LA RUEDA', 50, '78.00', 40, '78.00', 49),
(49, 'FILTRO DE COMBUSTIBLE', 40, '95.00', 35, '95.00', 50),
(50, 'EMBELLECEDORES', 46, '185.00', 25, '185.00', 60);
...
(38, '41639565', 'Heber Ivan', 'CAL.SAN SALVADOR NRO. 1197 P.J. LUJAN (SEGUNDO PISO) ', '978843610', 'hmejiac@crece.uss.edu.pe', 1);
...
INSERT INTO `proveedor` (`idPersona`, `razonComercial`) VALUES
(1, 'MOSTACERO ABANTO ANGELA JOSEL S.A.C'),
(9, 'NECIOSUP CABANILLAS JOSE ANTONIO S.A.C'),
(10, 'OMEGA PERU S.A'),
(13, 'ROSAS PLANNING EST S.A'),
(14, 'POLISSISTEMAS S.A.C'),
(15, 'RECONOR S.R.L'),
(16, 'RECORD MULTIMOTRIZ S.A'),
(19, 'SELMA PERU S.R.L'),
(22, 'SERVICENTRO OCHOA S.R.L'),
(25, 'TALLERES GRAFICOS SILVA S.R.L'),
(26, 'TIENDAS EFE S.A'),
(29, 'TOTAL ARTEFACTOS S.A'),
(30, 'VISUAL DATA COMERCIAL S.A.C'),
(31, 'LIBRERIA BAZAR STOCK S.R.L'),
(37, 'MADERERA LOS CEDROS S.R.L');
...
INSERT INTO `repuesto` (`idProducto`, `imagen`) VALUES
(1, NULL),
(2, NULL),
(3, NULL),
(4, NULL),
...
INSERT INTO `servicio` (`idProducto`, `idTipoServicio`) VALUES
(101, 1),
(102, 1),
(104, 1),
(106, 1),
...
INSERT INTO `vehiculo` (`idVehiculo`, `placa`, `marca`, `modelo`, `observaciones`, `idPersonaCliente`) VALUES
(1, 'UA-114', 'Abarth', '124 Spide', 'Abolladura traseras', 2),
(2, 'ASD-145', 'Alfa Romero', 'Giulietta', 'Vidrio delantero parcialmente quebrado', 3),
(3, 'FDD-454', 'BYD', 'E6', '', 4),
(4, 'FDC-744', 'Caterham', 'Seven', 'Abolladura traseras', 11),
(5, 'AQQ-120', 'Cadillac', 'CTS', '', 12),
(6, 'FG-0122', 'Aston Martin', 'Rapide', 'Abolladura traseras', 18),
(7, 'GFF-154', 'BMW', 'X3', 'Vidrio delantero parcialmente quebrado', 20),
(8, 'HG-025', 'Honda', 'CR-V', 'Buenas condiciones', 21),
(9, 'HG-122', 'Ford', 'Focus', '', 27),
(10, 'JH-145', 'Fiat', '500X', 'Vidrio delantero parcialmente quebrado', 33),
(11, 'JKK-154', 'Bugatti', 'Chiron', '', 34),
(12, 'QEE-745', 'Jaguar', 'F-Type', 'Abolladuras multiples', 35),
(13, 'JHH-74', 'Volvo', 'XC60', '', 7),
(14, 'KJ-125', 'Volkswagen', 'Golf', 'Vidrio delantero parcialmente quebrado', 8),
(15, 'KLJ-544', 'TATA', 'Vista', '', 11),
(16, 'KL-1245', 'TATA', 'Xenon', '', 11),
(17, 'MM-2545', 'Subaru', 'Forester', 'Vidrio trasero abollado', 4),
(18, 'TTR-7444', 'Tesla', 'Model X', '', 7),
(19, 'RT-455', 'Toyota', 'Prius', 'Abolladuras multiples', 5),
(20, 'WET-122', 'Renault', 'Clio', '', 24),
(21, 'JKN-555', 'Renault', 'Mágane', '', 3),
(22, 'HTT-122', 'Nissan', 'GT-R', 'Abolladuras multiples', 8),
(23, 'JH-257', 'Rolls-Royce', 'Phantom', '', 7),
(24, 'KU-236', 'Audi', 'A5', '', 20),
(25, 'BN-236', 'Audi', 'Q3', 'Abolladuras multiples', 27),
(26, 'MN-3656', 'Ford', 'Fiesta', '', 12),
(27, 'JH-785', 'Ford', 'Mustang', '', 5),
(28, 'RRR-588', 'Mercedes', 'Clase C', '', 2),
(29, 'JHH-287', 'McLaren', '540C', 'Vidrios rajados', 2),
(30, 'JUU-987', 'Maserati', 'Quattrporte', 'Condiciones Medias', 18),
(31, 'KKK-133', 'Lexus', 'IS', '', 4),
(32, 'RRR-7553', 'Jeep', 'Wrangler', '', 35),
(33, 'QWD-36', 'Ferrari', 'FF', 'Abolladuras multiples', 11),
(34, 'BG-369', 'Hyundai', 'i30', '', 21),
(35, 'JYH-123', 'Honda', 'Jazz', '', 35),
(36, 'EW-7889', 'Dacia', 'Duster', '', 34),
(37, 'RT-2366', 'BMW', 'Serie 3', 'Abolladuras minimas', 27),
(38, 'RTW-32', 'Aston Martin', 'DB9', '', 8),
(39, 'NHN-542', 'Fiat', '500X', '', 4),
(40, 'WAS-855', 'DS', 'DS4', '', 7),
(41, 'QWW-855', 'Ferrari', 'FF', '', 18),
(42, 'SS-658', 'Dacia', 'San11dero', '', 7),
(43, 'DFG-789', 'Toyota', 'S60', '', 5),
(44, 'JHU-215', 'Toyota', 'V40', '', 3),
(45, 'JOF-548', 'Volkswagen', 'Beetle', '', 24),
(46, 'QTE-584', 'Volvo', 'XC60', '', 35),
(47, 'BCN-542', 'Seat', 'Leon', '', 5),
(48, 'NV-545', 'Smart', 'ForTwo', '', 3),
(49, 'YE-320', 'Rolls-Royce', 'Phantom', '', 4),
(50, 'OIY-896', 'Seat', 'Ibiza', '', 12),
(51, 'LHK-854', 'Porsche', '911', '', 5),
(52, 'KG-87', 'Nissan', 'Qashqai', '', 24),
(53, 'NV-422', 'Morgan3', 'Wheeler', '', 5),
(54, 'VX-870', 'Morgan Aero', 'Cpupe', '', 11),
(55, 'QTA-879', 'Mazda', 'Mazda6', '', 35),
(56, 'CMJ-852', 'Mercedes', 'Clase C', '', 27),
(57, 'PQO-587', 'Maserati', 'Ghibli', '', 3),
(58, 'OQI-951', 'Mazda', 'CX-5', '', 12),
(59, 'ZAQ-852', 'Land Rover', 'Discovery', '', 11),
(60, 'PTO-456', 'KIA', 'Sportage', '', 18),
(61, 'MCJ-741', 'Jeep', 'Wrangler', '', 8),
(62, 'PQW-985', 'KIA', 'Rio', '', 35),
(63, 'PQO-210', 'Infiniti', 'QX50', '', 3),
(64, 'LO-159', 'Jaguar', 'F-Type', '', 11),
(65, 'POI-120', 'Ferrari', 'FF', '', 2),
(66, 'IJF-854', 'Caterham', 'Seven', '', 35),
(67, 'PQO-854', 'Ferrari', 'California T', '', 11),
(68, 'FHD-812', 'Audi', 'A5', '', 3),
(69, 'AQW-541', 'Bugatti', 'Chiron', '', 12);
...
ALTER TABLE `comprobantecompra`
  ...
  ADD KEY `fk_PersonaProveedor_ComprobanteCompra` (`idPersonaProveedor`);
...
ALTER TABLE `comprobanteventa`
  ...
  ADD KEY `fk_TipoComprobanteVenta_ComprobanteVenta` (`idTipoComprobanteVenta`);
...
ALTER TABLE `detallecompra`
  ...
  ADD KEY `fk_ProductoRepuesto_DetalleCompra` (`idProductoRepuesto`);
...
ALTER TABLE `kardex`
  ...
  ADD KEY `fk_ProductoRepuesto_Kardex` (`idProductoRepuesto`);
...
ALTER TABLE `vehiculo`
  ...
  ADD KEY `fk_Cliente_Vehiculo` (`idPersonaCliente`);
...
--
ALTER TABLE `detalleoperacion`
  MODIFY `idDetalleOperacion` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=29;
--
...
--
ALTER TABLE `tipocliente`
  MODIFY `idTipoCliente` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=9;
--
...
--
ALTER TABLE `tipoempleado`
  MODIFY `idTipoEmpleado` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=7;
--
...
--
ALTER TABLE `comprobantecompra`
  ADD CONSTRAINT `fk_PersonaProveedor_ComprobanteCompra` FOREIGN KEY (`idPersonaProveedor`) REFERENCES `proveedor` (`idPersona`);

--
-- Filtros para la tabla `comprobanteventa`
--
ALTER TABLE `comprobanteventa`
  ADD CONSTRAINT `fk_TipoComprobanteVenta_ComprobanteVenta` FOREIGN KEY (`idTipoComprobanteVenta`) REFERENCES `tipocomprobanteventa` (`idTipoComprobanteVenta`);
...
ALTER TABLE `detallecompra`
  ...
  ADD CONSTRAINT `fk_ProductoRepuesto_DetalleCompra` FOREIGN KEY (`idProductoRepuesto`) REFERENCES `repuesto` (`idProducto`);
...
--
ALTER TABLE `kardex`
  ADD CONSTRAINT `fk_ProductoRepuesto_Kardex` FOREIGN KEY (`idProductoRepuesto`) REFERENCES `repuesto` (`idProducto`);
...
--
ALTER TABLE `servicio`
  ADD CONSTRAINT `fk_Producto_Servicio` FOREIGN KEY (`idProducto`) REFERENCES `producto` (`idProducto`),
...
--
ALTER TABLE `vehiculo`
  ADD CONSTRAINT `fk_Cliente_Vehiculo` FOREIGN KEY (`idPersonaCliente`) REFERENCES `cliente` (`idPersona`);
